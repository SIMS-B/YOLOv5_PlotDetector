...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    # Trainloader
    train_loader, dataset, extraLabelsInformation = create_dataloader(train_path,
                                                                      imgsz,
    ...
    print("extraLabelsInformation in train.py: ", extraLabelsInformation)
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            with torch.cuda.amp.autocast(amp):
                ...
                # edited call to overloaded loss function with our extra labels' information
                loss, loss_items = compute_loss(pred, targets.to(
                    device), extraLabelsInformation)  # loss scaled by batch_size
